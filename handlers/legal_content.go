...
var legalContent = map[string]map[string]legalDoc{
	"privacy": {
		"mk": {
			...
			Intro:    "Оваа политика објаснува кои лични податоци ги собираме кога купувате на Bosfoot, зошто ги собираме и кои се вашите права. Bosfoot е управуван од Друштво за трговија и услуги БОСФУТ ТРЈЕД ДООЕЛ увоз-извоз Охрид, ЕДБ:4020026558013, со седиште на Ул. Димитар Влахов 49/9, 6000, Охрид.",
			Sections: []legalSection{
		...
		"sq": {
			...
			Intro:    "Kjo politikë shpjegon cilat të dhëna personale mbledhim kur blini te Bosfoot, pse i mbledhim dhe cilat janë të drejtat tuaja. Bosfoot operohet nga Drushtvo za trgovija i uslugi BOSFUT TREJD DOOEL uvoz-izvoz Ohrid, EDB:4020026558013, me seli në Ul. Dimitar Vlahov 49/9, 6000, Ohrid.",
			Sections: []legalSection{
		...
		"en": {
			...
			Intro:    "This policy explains what personal data we collect when you shop at Bosfoot, why we collect it, and your rights. Bosfoot is operated by Drushtvo za trgovija i uslugi BOSFUT TREJD DOOEL uvoz-izvoz Ohrid, EDB:4020026558013, registered at Ul. Dimitar Vlahov 49/9, 6000, Ohrid.",
			Sections: []legalSection{
	...
	"terms": {
		"mk": {
			...
			Sections: []legalSection{
				{"Општо", []string{"Онлајн продавницата Bosfoot е управувана од Друштво за трговија и услуги БОСФУТ ТРЈЕД ДООЕЛ увоз-извоз Охрид, ЕДБ:4020026558013, Ул. Димитар Влахов 49/9, 6000, Охрид. Контакт: info@bosfoot.com."}},
		...
		"sq": {
			...
			Sections: []legalSection{
				{"Të përgjithshme", []string{"Dyqani online Bosfoot operohet nga Drushtvo za trgovija i uslugi BOSFUT TREJD DOOEL uvoz-izvoz Ohrid, EDB:4020026558013, Ul. Dimitar Vlahov 49/9, 6000, Ohrid. Kontakt: info@bosfoot.com."}},
		...
		"en": {
			...
			Sections: []legalSection{
				{"General", []string{"The Bosfoot online store is operated by Drushtvo za trgovija i uslugi BOSFUT TREJD DOOEL uvoz-izvoz Ohrid, EDB:4020026558013, Ul. Dimitar Vlahov 49/9, 6000, Ohrid. Contact: info@bosfoot.com."}},
	...
	"shipping": {
		"mk": {
			...
			Updated:  "Последно ажурирано: јуни 2026",
			Intro:    "Доставуваме низ цела Северна Македонија преку Карго Експрес.",
			Sections: []legalSection{
				...
				{"Време на достава", []string{"Доставата преку Карго Експрес обично трае 2–5 работни дена до вашиот град."}},
				{"Трошоци", []string{"Трошокот за достава е 250 МКД. Бесплатна достава за нарачки над 3.500 МКД."}},
		...
		"sq": {
			...
			Updated:  "Përditësuar së fundi: qershor 2026",
			Intro:    "Dërgojmë në të gjithë Maqedoninë e Veriut përmes Kargo Ekspres.",
			Sections: []legalSection{
				...
				{"Afatet e dërgesës", []string{"Dërgesa përmes Kargo Ekspres zakonisht zgjat 2–5 ditë pune deri te qyteti juaj."}},
				{"Kostot", []string{"Kostoja e dërgesës është 250 MKD. Dërgesë falas për porositë mbi 3.500 MKD."}},
		...
		"en": {
			...
			Updated:  "Last updated: June 2026",
			Intro:    "We deliver across North Macedonia via Kargo Ekspres.",
			Sections: []legalSection{
				{"Delivery areas", []string{"We ship to addresses in North Macedonia. For international orders, contact us at info@bosfoot.com."}},
				{"Delivery times", []string{"Delivery via Kargo Ekspres usually takes 2–5 business days to your city."}},
				{"Costs", []string{"Shipping costs 250 MKD. Free shipping on orders over 3,500 MKD."}},
